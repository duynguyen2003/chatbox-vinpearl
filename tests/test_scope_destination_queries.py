...
def _supported_hanoi(user_message, rag_query=""):
    combined = f"{user_message} {rag_query}".lower()
    if "flight" in combined or "weather" in combined or "vé máy bay" in combined or "thời tiết" in combined:
        return []
